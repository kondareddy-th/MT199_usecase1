                    ...
                    {mode === 'convert' && result.mx_message && (
                      <div className="mb-6">
                        <div className="flex justify-between items-center mb-2">
                          <h3 className="text-lg font-semibold text-gray-800">MX Message</h3>
                          <button 
                            onClick={() => {
                              navigator.clipboard.writeText(result.mx_message);
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                          <thead className="bg-gray-50 sticky top-0">
                            <tr>
                              ...
                              {mode === 'convert' && (
                                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MX Available</th>
                              )}
                              {mode === 'extract' && (
